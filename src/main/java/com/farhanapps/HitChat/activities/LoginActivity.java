...
public class LoginActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.newRegister).setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        finish();
	...
	public void attemptLogin() {
		...
		if (TextUtils.isEmpty(mPassword)) {
			...
			cancel = true;
		} else if (mPassword.length() < 4|| mPassword.length() > 30) {
		...
		if (TextUtils.isEmpty(mEmail)) {
			...
			mEmailView.setError("Invalid Number");
			focusView = mEmailView;
			cancel = true;
		}
		...
		if (cancel) {
			...
			mLoginStatusMessageView.setText("please wait");
			showProgress(true);
	...
	public class UserLoginTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			String x=c.login(mEmail, mPassword);
